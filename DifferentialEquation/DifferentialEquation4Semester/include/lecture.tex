...
\begin{block}[Свойства функции Коши]
  ...
  % TODO: УЗНАТЬ О ТОМ ЧТО СДЕСЬ ДОЛЖНО БЫТЬ
\end{block}
...
\begin{block}[Лемма Гронуолла-Белмана]
...
\begin{theorem}[о ннепрерывной зависимости]
...
\begin{define}[устойчивости тривиального решения]
  $$
  \forall \varepsilon > 0
  ~~~
  \exists \delta_{\varepsilon}
...
\begin{theorem}[Ляпунов об устойчивости]
  I $K_2 = \{x \in D ~~~ ||x|| \le z\}$
...
% TODO: Описание алгоритма показана на примере, поэтому решить стоит ли сюда
% это вписывать
...
% TODO: но это не точно, как собственно и все
\begin{block}[Общее решение краевых задач]
  $$
  \left\{
  \begin{array}{l}
    x''(t) + a(t)x(t) = f(t) \\
