...
\bd{Свойства:}\\
\bd{I} Если F(x) - первообразная для $f(x)$ и определена на $\Delta$, то $F(x) + C$
...
\bd{II} Если $F_{1}(x), F_{2}(x)$ обе первообразнозные для $f(x)$ на $\Delta$,
то $F_{1}(x) - F_{2}(x) = C$.
...
\bd{Свойства:}
\bd{I} Диффиренциал от неопределенного интеграла равен подынтергальному
выражению:
