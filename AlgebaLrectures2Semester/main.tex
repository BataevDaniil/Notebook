...
\newenvironment{theorem}[1][\!\!]{\colorbox[rgb]{1, 0.4, 0.6}%
{\bd{Теорема #1:}}\\}{\\ \colorbox[rgb]{0, 0, 0}{1}\\} %Теорема

\newenvironment{proof}{\colorbox[rgb]{0, 0.8, 0.5}{\bd{Доказательство:}}\\}%
{\\ \colorbox[rgb]{0, 0, 0}{1}\\} %Доказательство

\newenvironment{defin}[1][\!\!]{\colorbox[rgb]{1, 0.4, 1}%
{\bd{Определение #1:}}\\}{\\\colorbox[rgb]{0, 0, 0}{1}\\}%definition определение
