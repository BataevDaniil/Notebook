...
\begin{define}[сходимости функциональной последовательности]
...
\begin{define}[радиуса сходимости степенного ряда]
...
\begin{define}[остаточного члена в форме Лагранжа]
  $$
